...
pub fn make_goal(day: u32, season: &SeasonKind) -> DailyGoal {
    ...
    match day % 18 {
        ...
        1 => DailyGoal {
            kind: GoalKind::WorkTimes,
            description: "Work 3 times today".to_string(),
            progress: 0.,
            target: 3.,
            reward_money: 30.,
            reward_happiness: 0.,
        ...
        2 => DailyGoal {
            kind: GoalKind::MaintainHappy,
            description: "Stay happy (60%+) all day".to_string(),
            progress: 0.,
            target: 1.,
            reward_money: 15.,
            reward_happiness: 10.,
        ...
        3 => DailyGoal {
            kind: GoalKind::EatTimes,
            description: "Eat 2 meals today".to_string(),
            progress: 0.,
            target: 2.,
            reward_money: 0.,
            reward_happiness: 20.,
        ...
        4 => DailyGoal {
            kind: GoalKind::ChatTimes,
            description: "Chat with 2 people".to_string(),
            progress: 0.,
            target: 2.,
            reward_money: 10.,
            reward_happiness: 15.,
        ...
        5 => DailyGoal {
            kind: GoalKind::FriendNpc,
            description: "Friendship 2 with any NPC".to_string(),
            progress: 0.,
            target: 2.,
            reward_money: 20.,
            reward_happiness: 10.,
        ...
        6 => DailyGoal {
            kind: GoalKind::SaveMoney,
            description: "Have $30+ in savings".to_string(),
            progress: 0.,
            target: 30.,
            reward_money: 15.,
            reward_happiness: 0.,
        ...
        7 => DailyGoal {
            kind: GoalKind::ExerciseTimes,
            description: "Exercise 2 times today".to_string(),
            progress: 0.,
            target: 2.,
            reward_money: 0.,
            reward_happiness: 20.,
        ...
        8 => DailyGoal {
            kind: GoalKind::LowerStress,
            description: "Get stress below 30".to_string(),
            progress: 0.,
            target: 30.,
            reward_money: 20.,
            reward_happiness: 10.,
        ...
        9 => DailyGoal {
            kind: GoalKind::BuildStreak,
            description: "Maintain a 3-day work streak".to_string(),
            progress: 0.,
            target: 3.,
            reward_money: 35.,
            reward_happiness: 5.,
        ...
        10 => DailyGoal {
            kind: GoalKind::MasterHobby,
            description: "Reach level 3 in any hobby".to_string(),
            progress: 0.,
            target: 3.,
            reward_money: 30.,
            reward_happiness: 0.,
        ...
        11 => DailyGoal {
            kind: GoalKind::EarnPassive,
            description: "Earn $10 passive income today".to_string(),
            progress: 0.,
            target: 10.,
            reward_money: 25.,
            reward_happiness: 0.,
        ...
        12 => DailyGoal {
            kind: GoalKind::OutdoorWeather,
            description: "Go outside on a Sunny day".to_string(),
            progress: 0.,
            target: 1.,
            reward_money: 20.,
            reward_happiness: 15.,
        ...
        13 => DailyGoal {
            kind: GoalKind::StudyTimes,
            description: "Study 2 times today ($30 ea)".to_string(),
            progress: 0.,
            target: 2.,
            reward_money: 20.,
            reward_happiness: 5.,
        ...
        14 => DailyGoal {
            kind: GoalKind::FeedPet,
            description: "Feed your pet today".to_string(),
            progress: 0.,
            target: 1.,
            reward_money: 15.,
            reward_happiness: 20.,
        ...
        15 => DailyGoal {
            kind: GoalKind::ThrowParty,
            description: "Throw a party today ($40)".to_string(),
            progress: 0.,
            target: 1.,
            reward_money: 10.,
            reward_happiness: 30.,
        ...
        16 => DailyGoal {
            kind: GoalKind::OwnVehicle,
            description: "Own a Bike or Car".to_string(),
            progress: 0.,
            target: 1.,
            reward_money: 30.,
            reward_happiness: 0.,
        ...
        _ => DailyGoal {
            kind: GoalKind::SeasonalGoal,
            description: seasonal_desc.into(),
            progress: 0.,
            target: seasonal_target,
            reward_money: 25.,
            reward_happiness: 10.,
            completed: false,
            failed: false,
